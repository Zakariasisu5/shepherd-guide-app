      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 sm:mb-8">
          <div>
            ...
            <p className="text-muted-foreground text-sm sm:text-base">Manage TGLW Global content and users</p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
          <Card className="border-l-4 border-l-primary hover:shadow-lg transition-shadow">
            ...
            <CardContent className="p-4 sm:p-6">
              <div className="text-2xl sm:text-3xl font-bold text-card-foreground">{stats.users}</div>
          ...
          <Card className="border-l-4 border-l-blue-500 hover:shadow-lg transition-shadow">
            ...
            <CardContent className="p-4 sm:p-6">
              <div className="text-2xl sm:text-3xl font-bold text-card-foreground">{stats.prayerRequests}</div>
          ...
          <Card className="border-l-4 border-l-amber-500 hover:shadow-lg transition-shadow">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 p-4 sm:p-6">
              ...
              <div className="p-2 bg-amber-500/10 rounded-lg">
                <Book className="h-4 w-4 sm:h-5 sm:w-5 text-amber-500" />
              </div>
            </CardHeader>
            <CardContent className="p-4 sm:p-6">
              <div className="text-2xl sm:text-3xl font-bold text-card-foreground">{stats.devotionals}</div>
          ...
          <Card className="border-l-4 border-l-purple-500 hover:shadow-lg transition-shadow">
            ...
            <CardContent className="p-4 sm:p-6">
              <div className="text-2xl sm:text-3xl font-bold text-card-foreground">{stats.mediaLinks}</div>
        ...
        <Tabs defaultValue="prayer-requests" className="space-y-4">
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 bg-muted/50 p-1 gap-1">
            <TabsTrigger value="prayer-requests" className="data-[state=active]:bg-background text-xs sm:text-sm">
              <MessageSquare className="h-3 w-3 sm:h-4 sm:w-4 mr-1 sm:mr-2" />
              <span className="hidden xs:inline">Prayer Requests</span>
              <span className="xs:hidden">Prayers</span>
            </TabsTrigger>
            <TabsTrigger value="devotionals" className="data-[state=active]:bg-background text-xs sm:text-sm">
              <Book className="h-3 w-3 sm:h-4 sm:w-4 mr-1 sm:mr-2" />
              <span className="hidden xs:inline">Devotionals</span>
              <span className="xs:hidden">Daily</span>
            </TabsTrigger>
            <TabsTrigger value="media" className="data-[state=active]:bg-background text-xs sm:text-sm">
              <Video className="h-3 w-3 sm:h-4 sm:w-4 mr-1 sm:mr-2" />
              <span className="hidden xs:inline">Media Links</span>
              <span className="xs:hidden">Media</span>
            </TabsTrigger>
            <TabsTrigger value="about" className="data-[state=active]:bg-background text-xs sm:text-sm">
              <FileText className="h-3 w-3 sm:h-4 sm:w-4 mr-1 sm:mr-2" />
              <span className="hidden xs:inline">About Content</span>
              <span className="xs:hidden">About</span>
            </TabsTrigger>
            <TabsTrigger value="users" className="data-[state=active]:bg-background text-xs sm:text-sm col-span-2 sm:col-span-1">
